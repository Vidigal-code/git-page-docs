...
export function buildRootConfig(options = {}) {
  ...
  const layoutsLinks = resolveLayoutsLinks(githubOwner, githubRepo, options.layoutsDir);
  ...
  return {
    site: {
      ...
      layoutsConfigPath: useLocalLayoutConfig ? layoutsLinks.config : "",
      layoutsConfigPathTemplates: useLocalLayoutConfig ? layoutsLinks.templates : "",
