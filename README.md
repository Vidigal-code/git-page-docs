...
Docs deploy at the repository root, e.g. `https://your-user.github.io/your-repository/v/1.1.63/?lang=en`.
...
Then docs are at `https://your-user.github.io/your-repository/docs/v/1.1.63/?lang=en`.
...
| `version` | e.g. `1.1.63` | Version (alternative to path) |
...
- Repository pinned version:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en
- Project version path without owner/repo:
  https://vidigal-code.github.io/git-page-docs/v/1.1.63/?lang=en
- Version through query parameter:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/?lang=en&version=1.1.63

**Markdown pages by route id**

- Getting Started (`id=1`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=1
- Project overview (`id=2`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=2
- Functionalities (`id=3`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=3
- GitHub issues and projects (`id=4`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=4
- Introduction to Git (`id=5`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=5
- Authorized routes (`id=6`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=6

**Markdown pages by slug (`name`)**

- Getting Started:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=getting-started
- Project overview:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=project-overview
- Functionalities:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=functionalities
- GitHub issues and projects:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=github-issues-projects
- Introduction to Git:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=git-introduction
- Authorized routes:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&name=authorized-routes

**Source viewer**

- Source viewer page inside the docs shell (`id=7`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=7
...
- Interactive vs non-interactive modes (`id=8`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=8
- GitHub issues and projects video (`id=9`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=9
- Python tutor video (`id=10`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=10
- Git introduction video (`id=11`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=11

**Audio pages**

- Audio track (`id=12`):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=12

**Fullscreen modes**

- Markdown fullscreen:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?mdfull=en&file=gitpagedocs/docs/versions/1.1.63/en/getting-started.md
- HTML fullscreen pattern (requires a configured HTML route):
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?htmlfull=en&file=gitpagedocs/docs/versions/1.1.63/en/example.html
- Video fullscreen by route id:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?videofull=en&id=8
- Video fullscreen by slug:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?videofull=en&slug=bdIJkGr2NV0
- Audio fullscreen by route id:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?audiofull=en&id=12
- Audio fullscreen by slug:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?audiofull=en&slug=0w80F8FffQ4

**Theme and heading selection**

- aurora-dark theme:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&theme=aurora-dark
- aurora-light theme:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&theme=aurora-light
- Legacy mode parameter:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&modetheme=dark
- Scroll to a Markdown heading:
  https://vidigal-code.github.io/git-page-docs/Vidigal-code/git-page-docs/v/1.1.63/?lang=en&menu=en&id=1#quick-start
  ...
  "routes-md": [
    {
      "id": 6,
      "path": {
        "en": "gitpagedocs/docs/versions/1.1.63/en/authorized-routes.md",
        "pt": "gitpagedocs/docs/versions/1.1.63/pt/authorized-routes.md",
        "es": "gitpagedocs/docs/versions/1.1.63/es/authorized-routes.md"
      },
      "authorization": {
